...
d_start() {
    ...
    nohup ${JAVA_HOME}/bin/java -D${PROFILE} -Dspring.profiles.active=dev -javaagent:/Users/luweihong/Downloads/apache-skywalking-apm-bin/agent/skywalking-agent.jar=agent.service_name=${PROFILE}_${PROJECT_NAME} -jar -Xms256m -Xmx512m ${MAIN_CLASS}  >/dev/null 2>&1 &
}
