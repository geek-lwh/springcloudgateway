...
public class FilterProcessOrderedConstant {
    ...
    // 修改请求返回体过滤器 order = -21
    public static int MODIFY_RESPONSE_BODY_GATEWAY_FILTER_ORDER = WRITE_RESPONSE_FILTER_ORDER - STEP;

    // 修改请求返回报头过滤器 order = -20
    public static int MODIFY_RESPONSE_HEADER_GATEWAY_FILTER_ORDER = MODIFY_RESPONSE_BODY_GATEWAY_FILTER_ORDER - STEP;
